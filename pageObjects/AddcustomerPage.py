...
class AddCustomer:
    ...
    def clickOnCustomersMenuItem(self):
        ...
        self.customer_menu=self.driver.find_element(By.XPATH, self.lnkCustomers_menuitem_xpath)
        self.driver.execute_script("arguments[0].click();", self.customer_menu)
    ...
    def setCustomerRoles(self,role):
        ...
        if role == 'Registered':
            ...
            time.sleep(3)
            #Identify the Register element and click
